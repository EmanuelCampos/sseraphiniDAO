...
export type ProposalQueuedEvent = TypedEvent<[BigNumber, BigNumber] & { proposalId: BigNumber; eta: BigNumber }>;
...
export class GovernorCompatibilityBravo extends BaseContract {
  ...
  filters: {
    ...
    "ProposalQueued(uint256,uint256)"(
      proposalId?: null,
      eta?: null
    ): TypedEventFilter<[BigNumber, BigNumber], { proposalId: BigNumber; eta: BigNumber }>;
