...
export class GovernorWithTwoTokens extends BaseContract {
  ...
  filters: {
    "ProposalCanceled(uint256)"(proposalId?: null): TypedEventFilter<[BigNumber], { proposalId: BigNumber }>;

    ProposalCanceled(proposalId?: null): TypedEventFilter<[BigNumber], { proposalId: BigNumber }>;
    ...
    "ProposalExecuted(uint256)"(proposalId?: null): TypedEventFilter<[BigNumber], { proposalId: BigNumber }>;

    ProposalExecuted(proposalId?: null): TypedEventFilter<[BigNumber], { proposalId: BigNumber }>;
    ...
    ): TypedEventFilter<[BigNumber, BigNumber], { oldQuorumNumerator: BigNumber; newQuorumNumerator: BigNumber }>;
  ...
  estimateGas: {
    ...
    addVaultForVoting(vault: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
